clear all;close all;
% calculate Cg
file_glo='../ww3.2019.nc';
file_trk='/projects/DEIKE/XiaohuiZhou/ReevaluatedFluxData/StructureData/ANDREXII/CO2_Flux.mat'
...
ust_trk=[];vst_trk=[];wcc_trk=[];
hs_trk=[];wva_trk=[];uwnd_trk=[];vwnd_trk=[];
